      ...
      <MDBTable className='mb-3 container-fluid border' style={{fontSize:"12px"}}>
        ...
        <MDBTableBody>
          ...
          state.map(st=>(
            ...
            <td>
                <MDBBtn className='py-1' color='primary' size='sm' href={`/editStudent/${st._id}`}>
                    <small>Edit</small>
                </MDBBtn>
                <MDBBtn className='py-1 mx-2' color='danger' size='sm' onClick={()=>{deleteStudentDetails(st._id)}}>
                    <small>Delete</small>
                </MDBBtn>
            </td>
            </tr>
